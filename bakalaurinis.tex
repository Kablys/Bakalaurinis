...
\usepackage{listings}
%\usepackage{subfig}
\usepackage{subcaption} % For subfigure to work
\usepackage{url}
\usepackage{wrapfig}
...
\reviewer{Prof., Dr. Rimantas Vaicekauskas}
...
\hline
Kalbos dalys ir elementai & \multicolumn{1}{l|}{Procentais} & \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}Procentais, be \\ nežinomų žodžių\end{tabular}} & \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}\cite{utka2009davzninis} tyrimo\\ duomenys\end{tabular}} \\ \hline
